...
| Date       | Summary |
| ---------- | ------- |
| 2026-06-02 | **Conditional Type 2 cleanups**: Removed the redundant "Condition Type" section and the "Else Branch" section heading. Implemented a "Load More" feature for the Boolean Attributes list in `ConditionalBranchV2Config.tsx` to show only 3 attributes initially (plus any currently selected ones) with a toggle to load/collapse the rest. Verified TypeScript compilation. |
